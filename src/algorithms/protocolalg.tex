...
(*@$\Pi\left(\Delta_1, \Delta_2, \Delta_3\right)$ \Reactivatenumber@*)
Declarations:
  set offeredSats
...
Upon receiving message satisfy((*@$d\mbox{, }L$@*)) from (*@$\mathcal{E}$@*):
  ...
  While aux is not empty
    ...
    Else If response == IcanSatisfy((*@$d\mbox{, }x$@*))
      ...
      responseFromLedger = wait for response from (*@$\mathcal{F}_{Ledger}$@*) for (*@$\Delta_2$@*)
      If responseFromLedger == youHaveBalance((*@$x$@*))
        ...
        response2 = wait for response from (*@$Bob$@*) for (*@$\Delta_3$@*) steps
